<div class="titulo">Emails de Eventos
    <div class="opciones_menu">
        <a href="<?= base_url() ?>admin/emails_eventos/crear"><img class="ico_agregar" src="<?= base_url(); ?>css/general/img/t.gif" title="Añadir un nuevo email"></a>
    </div>
</div>
<div class="contenido">
    <div class="contenedortablabuscar">
        <form action="<?= base_url() ?>admin/emails_eventos" id="form_buscar" method="post" >
            <table>
                <tbody>
                    <tr>
                        <td>Buscar:</td>
