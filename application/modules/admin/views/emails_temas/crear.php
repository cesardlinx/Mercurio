<div class='titulo'>Crear email de tema</div>
<div class="contenido">
    <form action="<?= base_url() ?>admin/emails_temas/almacenar" id="form_almacenar" method="post">
        ...
        <input type="hidden" name="eml_fecha" value="<?= hoy('c'); ?>">       
    </form>
</div>
